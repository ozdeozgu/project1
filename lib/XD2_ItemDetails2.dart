...
class XD2_ItemDetails2 extends StatelessWidget {
  XD2_ItemDetails2({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(187.0, 0.0, 189.0, 55.0),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 189.0, 55.0),
                    size: Size(376.0, 55.0),
                    pinLeft: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(235.0, 14.0, 93.0, 27.0),
                    size: Size(376.0, 55.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(31.0, 14.0, 127.0, 27.0),
                    size: Size(376.0, 55.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
