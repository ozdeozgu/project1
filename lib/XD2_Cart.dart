...
class XD2_Cart extends StatelessWidget {
  XD2_Cart({
    Key key,
  }) : super(key: key);
  @override
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 22.0, 33.0, 21.0),
                          size: Size(114.0, 118.0),
                          pinLeft: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 3.0, 114.0, 39.0),
                                      size: Size(114.0, 42.0),
                                      pinLeft: true,
                                      pinRight: true,
                                      pinTop: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(9.0, 0.0, 13.0, 41.0),
                                      size: Size(114.0, 42.0),
                                      pinLeft: true,
                                      pinTop: true,
                                      pinBottom: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(92.0, 7.0, 12.0, 27.0),
                                      size: Size(114.0, 42.0),
                                      pinRight: true,
                                      fixedWidth: true,
                                      fixedHeight: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(52.0, 10.0, 10.0, 22.0),
                                      size: Size(114.0, 42.0),
                                      fixedWidth: true,
                                      fixedHeight: true,
                                      child: Text(
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 22.0, 71.0, 21.0),
                                size: Size(114.0, 118.0),
                                pinLeft: true,
                                fixedWidth: true,
                                fixedHeight: true,
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 0.0, 91.0, 21.0),
                                size: Size(114.0, 118.0),
                                pinLeft: true,
                                pinTop: true,
                                fixedWidth: true,
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, -29.0, 100.0, 150.0),
                                size: Size(100.0, 104.0),
                                pinLeft: true,
                                pinRight: true,
                                pinTop: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(122.6, 41.0, 79.0, 22.0),
                          size: Size(326.0, 138.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(115.0, 14.0, 82.0, 27.0),
                    size: Size(326.0, 55.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
